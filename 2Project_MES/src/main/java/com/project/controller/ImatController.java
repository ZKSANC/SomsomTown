...
//		주소줄 변경하면서 이동 
	...
	public String IomatList(HttpServletRequest request, Model model) {
		...
		model.addAttribute("pageDTO", pageDTO);
		System.out.println("ImatController iomatList()-4");
...
//		/WEB-INF/views/fcenter/fnotice.jsp
	...
	@RequestMapping(value = "/iomat/iomatsear", method = RequestMethod.GET)
	public String iomatsear(HttpServletRequest request, Model model) {
		System.out.println("IomatController iomatsear()");
		//검색어 가져오기
		String search=request.getParameter("search");
		String search2=request.getParameter("search2");
		String search3=request.getParameter("search3");
