...
<div class="animated fadeIn">
				<div class="row">
					...
					<div class="card-body card-block">
							...
							<label class="pr-1 form-control-label">입고번호</label>&nbsp;&nbsp;
							<input type="text" name="search" class="form-control" placeholder="In-material code">
							</div>
							<div class="form-group col-6 mb-1">
							...
							<div class="form-group col-6 mb-1">
							<label class="pr-1 form-control-label">입고창고</label>&nbsp;&nbsp;
							<input type="text" name="search3" class="form-control" placeholder="In-material storage">
				...
				<div class="row">
					<div class="col-lg">
						...
						<form method="post" name="fr" action="${pageContext.request.contextPath}/imat/imatinsertPro" id="insertpro" onsubmit="prodchk(event);">
										...
										class="imat_cd" style="width:100px;" placeholder="자동추가" readonly></td>
													<td><input type="text" name="imat_date"
										class="imat_date" style="width:100px;" disabled></td>
													<td><input
										...
										type="text" name="prod_unit" class="prod_unit" id="prod_unit" style="width:90px;" disabled></td>
													<td><input type="text" name="imat_stg" class="imat_stg" id="imat_stg" style="width:90px;" readonly></td>
													<td><input type="text" name="imat_count" id="imat_count" 
										class="imat_count"style="width:90px;" ></td>
													<td><input
...
<%-- 														onclick="location.href='${pageContext.request.contextPath}/imat/imatupdate?imat_cd=${ImatDTO.imat_cd}&iomat_count=${ImatDTO.imat_count}'"> --%>
														<input type="button" value="수정" class="btn btn-secondary" onclick="location.href='${pageContext.request.contextPath}/imat/imatupdate?imat_cd=${ImatDTO.imat_cd}&iomat_count=${ImatDTO.imat_count}'">
